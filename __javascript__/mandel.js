"use strict";
// Transcrypt'ed from Python, 2016-08-26 16:03:04
function mandel () {
	var __all__ = {};
...
/* 000008 */ 							self.transpiler_version = '3.5.213';
...
/* 000011 */ 		}
/* 000011 */ 	);
/* 000011 */ /* 000001 */ 	__nest__ (
/* 000001 */ 		__all__,
/* 000001 */ 		'org.transcrypt.__standard__', {
/* 000001 */ 			__all__: {
/* 000001 */ 				__inited__: false,
/* 000001 */ 				__init__: function (__all__) {
/* 000012 */ 					var Exception = __class__ ('Exception', [object], {
/* 000013 */ 						get __init__ () {return __get__ (this, function (self) {
/* 000013 */ 							var args = tuple ([].slice.apply (arguments).slice (1));
/* 000014 */ 							self.args = args;
/* 000014 */ 						});},
/* 000016 */ 						get __repr__ () {return __get__ (this, function (self) {
/* 000017 */ 							if (len (self.args)) {
/* 000018 */ 								return '{}{}'.format (self.__class__.__name__, repr (tuple (self.args)));
/* 000018 */ 							}
/* 000018 */ 							else {
/* 000020 */ 								return '{}()'.format (self.__class__.__name__);
/* 000020 */ 							}
/* 000020 */ 						});},
/* 000022 */ 						get __str__ () {return __get__ (this, function (self) {
/* 000023 */ 							if (len (self.args) > 1) {
/* 000024 */ 								return str (tuple (self.args));
/* 000024 */ 							}
/* 000024 */ 							else {
/* 000025 */ 								if (len (self.args)) {
/* 000026 */ 									return str (self.args [0]);
/* 000026 */ 								}
/* 000026 */ 								else {
/* 000028 */ 									return '';
/* 000028 */ 								}
...
/* 000028 */ 						});}
/* 000028 */ 					});
/* 000030 */ 					var StopIteration = __class__ ('StopIteration', [object], {
/* 000031 */ 						get __init__ () {return __get__ (this, function (self) {
/* 000032 */ 							Exception.__init__ (self, 'Iterator exhausted');
/* 000032 */ 						});}
/* 000032 */ 					});
/* 000034 */ 					var ValueError = __class__ ('ValueError', [Exception], {
/* 000034 */ 					});
/* 000037 */ 					var AssertionError = __class__ ('AssertionError', [Exception], {
/* 000037 */ 					});
/* 000042 */ 					var __sort__ = function (iterable, key, reverse) {
/* 000042 */ 						if (typeof key == 'undefined' || (key != null && key .__class__ == __kwargdict__)) {;
/* 000042 */ 							var key = null;
/* 000042 */ 						};
/* 000042 */ 						if (typeof reverse == 'undefined' || (reverse != null && reverse .__class__ == __kwargdict__)) {;
/* 000042 */ 							var reverse = false;
/* 000042 */ 						};
/* 000042 */ 						if (arguments.length) {
/* 000042 */ 							var __ilastarg0__ = arguments.length - 1;
/* 000042 */ 							if (arguments [__ilastarg0__] && arguments [__ilastarg0__].__class__ == __kwargdict__) {
/* 000042 */ 								var __allkwargs0__ = arguments [__ilastarg0__--];
/* 000042 */ 								for (var __attrib0__ in __allkwargs0__) {
/* 000042 */ 									switch (__attrib0__) {
/* 000042 */ 										case 'iterable': var iterable = __allkwargs0__ [__attrib0__]; break;
/* 000042 */ 										case 'key': var key = __allkwargs0__ [__attrib0__]; break;
/* 000042 */ 										case 'reverse': var reverse = __allkwargs0__ [__attrib0__]; break;
/* 000042 */ 									}
/* 000042 */ 								}
/* 000042 */ 							}
/* 000042 */ 						}
...
/* 000042 */ 						}
/* 000043 */ 						if (key) {
/* 000044 */ 							iterable.sort ((function __lambda__ (a, b) {
/* 000044 */ 								if (arguments.length) {
/* 000044 */ 									var __ilastarg0__ = arguments.length - 1;
/* 000044 */ 									if (arguments [__ilastarg0__] && arguments [__ilastarg0__].__class__ == __kwargdict__) {
/* 000044 */ 										var __allkwargs0__ = arguments [__ilastarg0__--];
/* 000044 */ 										for (var __attrib0__ in __allkwargs0__) {
/* 000044 */ 											switch (__attrib0__) {
/* 000044 */ 												case 'a': var a = __allkwargs0__ [__attrib0__]; break;
/* 000044 */ 												case 'b': var b = __allkwargs0__ [__attrib0__]; break;
/* 000044 */ 											}
/* 000044 */ 										}
/* 000044 */ 									}
/* 000044 */ 								}
/* 000044 */ 								else {
/* 000044 */ 								}
/* 000044 */ 								return key (a) > key (b);
/* 000044 */ 							}));
/* 000044 */ 						}
/* 000044 */ 						else {
/* 000046 */ 							iterable.sort ();
/* 000046 */ 						}
/* 000048 */ 						if (reverse) {
/* 000049 */ 							iterable.reverse ();
/* 000049 */ 						}
/* 000049 */ 					};
/* 000051 */ 					var sorted = function (iterable, key, reverse) {
/* 000051 */ 						if (typeof key == 'undefined' || (key != null && key .__class__ == __kwargdict__)) {;
/* 000051 */ 							var key = null;
/* 000051 */ 						};
/* 000051 */ 						if (typeof reverse == 'undefined' || (reverse != null && reverse .__class__ == __kwargdict__)) {;
/* 000051 */ 							var reverse = false;
/* 000051 */ 						};
/* 000051 */ 						if (arguments.length) {
/* 000051 */ 							var __ilastarg0__ = arguments.length - 1;
/* 000051 */ 							if (arguments [__ilastarg0__] && arguments [__ilastarg0__].__class__ == __kwargdict__) {
/* 000051 */ 								var __allkwargs0__ = arguments [__ilastarg0__--];
/* 000051 */ 								for (var __attrib0__ in __allkwargs0__) {
/* 000051 */ 									switch (__attrib0__) {
/* 000051 */ 										case 'iterable': var iterable = __allkwargs0__ [__attrib0__]; break;
/* 000051 */ 										case 'key': var key = __allkwargs0__ [__attrib0__]; break;
/* 000051 */ 										case 'reverse': var reverse = __allkwargs0__ [__attrib0__]; break;
/* 000051 */ 									}
/* 000051 */ 								}
/* 000051 */ 							}
/* 000051 */ 						}
/* 000051 */ 						else {
/* 000051 */ 						}
/* 000052 */ 						if (type (iterable) == dict) {
/* 000053 */ 							var result = copy (iterable.keys ());
/* 000053 */ 						}
/* 000053 */ 						else {
/* 000055 */ 							var result = copy (iterable);
/* 000055 */ 						}
/* 000057 */ 						__sort__ (result, key, reverse);
/* 000058 */ 						return result;
/* 000058 */ 					};
/* 000063 */ 					var map = function (func, iterable) {
/* 000064 */ 						return function () {
/* 000064 */ 							var __accu0__ = [];
/* 000064 */ 							var __iterable0__ = iterable;
/* 000064 */ 							for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
/* 000064 */ 								var item = __iterable0__ [__index0__];
/* 000064 */ 								__accu0__.append (func (item));
/* 000064 */ 							}
/* 000064 */ 							return __accu0__;
/* 000064 */ 						} ();
/* 000064 */ 					};
/* 000067 */ 					var filter = function (func, iterable) {
/* 000068 */ 						return function () {
/* 000068 */ 							var __accu0__ = [];
/* 000068 */ 							var __iterable0__ = iterable;
/* 000068 */ 							for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
/* 000068 */ 								var item = __iterable0__ [__index0__];
/* 000068 */ 								if (func (item)) {
/* 000068 */ 									__accu0__.append (item);
/* 000068 */ 								}
/* 000068 */ 							}
/* 000068 */ 							return __accu0__;
/* 000068 */ 						} ();
/* 000068 */ 					};
/* 000144 */ 					var __Terminal__ = __class__ ('__Terminal__', [object], {
/* 000145 */ 						get __init__ () {return __get__ (this, function (self) {
/* 000146 */ 							try {
/* 000147 */ 								self.element = document.getElementById ('__terminal__');
/* 000147 */ 							}
/* 000147 */ 							catch (__except0__) {
/* 000149 */ 								self.element = null;
/* 000149 */ 							}
/* 000150 */ 							if (self.element) {
/* 000151 */ 								self.buffer = '';
/* 000152 */ 								self.element.style.overflowX = 'auto';
/* 000153 */ 								self.element.style.padding = '5px';
/* 000154 */ 								self.element.innerHTML = '_';
/* 000154 */ 							}
/* 000156 */ 						});},
/* 000158 */ 						get print () {return __get__ (this, function (self) {
/* 000158 */ 							var sep = ' ';
/* 000158 */ 							var end = '\n';
/* 000158 */ 							if (arguments.length) {
/* 000158 */ 								var __ilastarg0__ = arguments.length - 1;
/* 000158 */ 								if (arguments [__ilastarg0__] && arguments [__ilastarg0__].__class__ == __kwargdict__) {
...
/* 000158 */ 											case 'sep': var sep = __allkwargs0__ [__attrib0__]; break;
/* 000158 */ 											case 'end': var end = __allkwargs0__ [__attrib0__]; break;
/* 000158 */ 										}
/* 000158 */ 									}
/* 000158 */ 								}
/* 000158 */ 								var args = tuple ([].slice.apply (arguments).slice (1, __ilastarg0__ + 1));
/* 000158 */ 							}
/* 000158 */ 							else {
/* 000158 */ 								var args = tuple ();
/* 000158 */ 							}
/* 000159 */ 							if (self.element) {
/* 000160 */ 								self.buffer = '{}{}{}'.format (self.buffer, sep.join (function () {
/* 000160 */ 									var __accu0__ = [];
/* 000160 */ 									var __iterable0__ = args;
/* 000160 */ 									for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
/* 000160 */ 										var arg = __iterable0__ [__index0__];
/* 000160 */ 										__accu0__.append (str (arg));
/* 000160 */ 									}
/* 000160 */ 									return __accu0__;
/* 000160 */ 								} ()), end).__getslice__ (-(4096), null, 1);
/* 000161 */ 								self.element.innerHTML = self.buffer.py_replace ('\n', '<br>');
/* 000162 */ 								self.element.scrollTop = self.element.scrollHeight;
/* 000162 */ 							}
/* 000162 */ 							else {
/* 000164 */ 								console.log (sep.join (args));
/* 000164 */ 							}
/* 000164 */ 						});},
/* 000166 */ 						get input () {return __get__ (this, function (self, question) {
/* 000166 */ 							if (arguments.length) {
/* 000166 */ 								var __ilastarg0__ = arguments.length - 1;
/* 000166 */ 								if (arguments [__ilastarg0__] && arguments [__ilastarg0__].__class__ == __kwargdict__) {
...
/* 000166 */ 											case 'question': var question = __allkwargs0__ [__attrib0__]; break;
/* 000166 */ 										}
/* 000166 */ 									}
/* 000166 */ 								}
/* 000166 */ 							}
/* 000166 */ 							else {
/* 000166 */ 							}
/* 000167 */ 							self.print ('{}_'.format (question), __kwargdict__ ({end: ''}));
/* 000168 */ 							try {
/* 000169 */ 								var answer = window.prompt (question);
/* 000169 */ 							}
/* 000169 */ 							catch (__except0__) {
/* 000171 */ 								console.log ('Error: Blocking input not yet implemented outside browser');
/* 000171 */ 							}
/* 000172 */ 							self.buffer = self.buffer.__getslice__ (0, -(1), 1);
/* 000173 */ 							self.print (answer);
/* 000174 */ 							return answer;
/* 000176 */ 						});}
/* 000176 */ 					});
/* 000178 */ 					var __terminal__ = __Terminal__ ();
/* 000178 */ 					__pragma__ ('<all>')
/* 000178 */ 						__all__.AssertionError = AssertionError;
/* 000178 */ 						__all__.Exception = Exception;
/* 000178 */ 						__all__.StopIteration = StopIteration;
/* 000178 */ 						__all__.ValueError = ValueError;
/* 000178 */ 						__all__.__Terminal__ = __Terminal__;
/* 000178 */ 						__all__.__sort__ = __sort__;
/* 000178 */ 						__all__.__terminal__ = __terminal__;
/* 000178 */ 						__all__.filter = filter;
/* 000178 */ 						__all__.map = map;
/* 000178 */ 						__all__.sorted = sorted;
/* 000178 */ 					__pragma__ ('</all>')
/* 000178 */ 				}
/* 000178 */ 			}
/* 000178 */ 		}
